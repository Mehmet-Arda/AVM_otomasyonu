...
{
    public partial class frm_m_magaza_personel_islemleri : Form
    {
        ...
        public frm_m_magaza_personel_islemleri()
        {
            InitializeComponent();
        }

        private void magaza_personel_islemleri_Load(object sender, EventArgs e)
        {
        ...
        private void btn_ekle_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand komut0 = new SqlCommand("Insert magaza_personel(personel_adi, personel_soyadi, telno,adres, pozisyon, calisma_yeri, maas, vardiya) VALUES(@ad, @soyad, @telNo,1, (Select pozisyon_id From pozisyon Where pozisyon_adi = @pozisyon), @magaza_id, @maas, (Select vardiya_id From vardiya Where vardiya_saat_araligi = @vardiya))", baglanti);
        ...
        private void btn_listele_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand komut0 = new SqlCommand("Select mp.personel_adi as 'Personel Adı', mp.personel_soyadi as'Personel Soyadı',poz.pozisyon_adi as 'Pozisyonu' , mp.maas as 'Maaşı',v.vardiya_saat_araligi as 'Çalışma Saatleri'  From magaza_personel mp join pozisyon poz on poz.pozisyon_id=mp.pozisyon join adres a on a.adres_id=mp.adres join vardiya v on v.vardiya_id=mp.vardiya Where mp.calisma_yeri=@magaza_id", baglanti);
            komut0.Parameters.AddWithValue("@magaza_id", magaza_id);
        ...
        private void btn_guncelle_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand komut0 = new SqlCommand("Update magaza_personel Set personel_adi =@ad, personel_soyadi = @soyad, telno = @telNo,adres=@adres, pozisyon = (Select pozisyon_id From pozisyon Where pozisyon_adi=@pozisyon),calisma_yeri=@magaza_id,maas=@maas,vardiya=(Select vardiya_id From vardiya Where vardiya_saat_araligi=@vardiya) Where magaza_personel.personel_id=@personel_id", baglanti);
            komut0.Parameters.AddWithValue("@ad", txt_ad.Text);
            komut0.Parameters.AddWithValue("@soyad", txt_soyad.Text);
            komut0.Parameters.AddWithValue("@telNo", mtb_telNo.Text);
            komut0.Parameters.AddWithValue("@pozisyon", cmb_pozisyon.SelectedItem);
        ...
        private void btn_ara_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand komut0 = new SqlCommand("Select mp.personel_adi as 'Personel Adı', mp.personel_soyadi as'Personel Soyadı',poz.pozisyon_adi as 'Pozisyonu' , mp.maas as 'Maaşı',v.vardiya_saat_araligi as 'Çalışma Saatleri'  From magaza_personel mp join pozisyon poz on poz.pozisyon_id=mp.pozisyon join adres a on a.adres_id=mp.adres join vardiya v on v.vardiya_id=mp.vardiya Where mp.calisma_yeri=@magaza_id and mp.personel_adi like @personel_adi", baglanti);
            komut0.Parameters.AddWithValue("@magaza_id", magaza_id);
        ...
        private void btn_sil_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand komut0 = new SqlCommand("Delete From magaza_personel Where personel_id=@personel_id", baglanti);
            komut0.Parameters.AddWithValue("@personel_id", personel_id);
            komut0.ExecuteNonQuery();
        ...
        private void dg_personel_listesi_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand komut1 = new SqlCommand("Select personel_id From magaza_personel Where personel_adi=@ad and personel_soyadi=@soyad and pozisyon=(Select pozisyon_id From pozisyon Where pozisyon_adi=@pozisyon)", baglanti);
